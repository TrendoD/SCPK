...
import { PETANI_CRITERIA, PETANI_DEFAULT_WEIGHTS, SAMPLE_BUYERS, WEIGHT_PRESETS } from '../utils/constants'
...
function PetaniPage() {
  ...
  const handlePresetSelect = (presetKey) => {
    ...
    setWeights(WEIGHT_PRESETS.petani[presetKey].weights)
  }
          ...
          <section className="weight-section">
            ...
            <div className="weight-preset-section">
              ...
              <div className="preset-grid">
                {Object.entries(WEIGHT_PRESETS.petani).map(([key, preset]) => (
                  <div 
                    key={key}
